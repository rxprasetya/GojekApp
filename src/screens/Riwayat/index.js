  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>History</Text>
      </View>
      <ScrollView>
        <Main />
      </ScrollView>
    ...
    <View style={home.container}>
      <ScrollView horizontal style={{ paddingHorizontal: 20 }} showsHorizontalScrollIndicator={false}>
        <View style={{ backgroundColor: 'lightgrey', padding: 10, borderRadius: 25, marginHorizontal: 5 }}>
          <Text style={{ color: 'black' }}>Go-Car</Text>
        </View>
        <View style={{ backgroundColor: 'lightgrey', padding: 10, borderRadius: 25, marginHorizontal: 5 }}>
          <Text style={{ color: 'black' }}>Go-Ride</Text>
        </View>
        <View style={{ backgroundColor: 'lightgrey', padding: 10, borderRadius: 25, marginHorizontal: 5 }}>
          <Text style={{ color: 'black' }}>Go-Food</Text>
        </View>
      </ScrollView>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>13 November, 2023 18.18</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Jawa Timur Park</Text>
